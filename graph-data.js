...
const BOOKS = [
  ...
  },
  {
    ...
    concepts: ["risk-asymmetry", "systems-thinking", "identity", "decision-making", "mental-models", "negotiation"],
    topics: [],
    chapters: []
  },
  {
  ...
  },
  {
    ...
    concepts: ["systems-thinking", "risk-asymmetry", "long-term-thinking", "decision-making", "capital-allocation", "leadership"],
    topics: [],
    chapters: []
  },
  {
    ...
    concepts: ["long-term-thinking", "ownership", "risk-asymmetry", "entrepreneurship", "capital-allocation", "acquisition", "resilience", "leadership"],
    topics: [],
    chapters: []
  },
  {
    ...
    concepts: ["leadership", "systems-thinking", "identity", "habits-and-character", "communication", "influence"],
    topics: [],
    chapters: []
  },
  {
    ...
    concepts: ["systems-thinking", "leverage", "ownership", "leadership", "entrepreneurship", "influence"],
    topics: [],
    chapters: []
  },
  {
    ...
    concepts: ["systems-thinking", "leverage", "communication", "writing-craft", "influence", "public-speaking"],
    topics: [],
    chapters: []
  },
  {
  ...
  },
  {
    ...
    concepts: ["leverage", "long-term-thinking", "identity", "sales", "influence", "public-speaking"],
    topics: [],
    chapters: []
  },
  {
  ...
  },
  {
    ...
    concepts: ["identity", "systems-thinking", "leverage", "leadership", "communication", "influence", "negotiation", "public-speaking", "sales"],
    topics: [],
    chapters: []
  },
  {
  ...
  },
  {
    ...
    concepts: ["systems-thinking", "ownership", "leverage", "entrepreneurship", "innovation-and-disruption", "sales"],
    topics: [],
    chapters: []
  },
  {
    ...
    concepts: ["systems-thinking", "risk-asymmetry", "long-term-thinking", "entrepreneurship", "innovation-and-disruption", "sales"],
    topics: [],
    chapters: []
  },
  {
  ...
  },
  {
    ...
    concepts: ["systems-thinking", "capital-allocation", "ownership", "cashflow", "writing-craft"],
    topics: [],
    chapters: []
  },
  {
...
const CONCEPTS = [
  ...
  },
  {
    ...
    summary: "The practice of influencing people toward a shared goal through vision, trust, and the elevation of others' capacity. Leadership is not a position \u2014 it is a set of behaviors available to anyone willing to develop them. The best leaders create more leaders, not more followers.",
    books: ["drucker-leadership", "ceo-excellence", "leadership-challenge", "21-laws-leadership", "no-rules-rules", "first-90-days", "managing-up", "emotional-intelligence", "crucial-conversations", "good-to-great", "american-icon", "culture-code", "runnin-down-a-dream", "how-big-things-get-done"],
    unifiedPrinciple: "Leadership is influence, not position. It develops daily through behavior, not through title. The most durable leadership is built on trust earned through consistency, vulnerability, and genuine investment in the people around you."
  },
  {
    id: "communication",
    label: "Communication",
  ...
  },
  {
    ...
    summary: "Writing is thinking made visible. The discipline of writing \u2014 removing clutter, finding the core message, structuring for the reader's attention \u2014 is the discipline of clear thinking. Good writing is not about style; it is about clarity. Every word that does not earn its place costs the reader attention they will not spend again.",
    books: ["on-writing-well", "writing-busy-readers", "very-good-copy", "made-to-stick", "personal-mba"],
    unifiedPrinciple: "Strip to the essential. Write for the reader, not the writer. The best writing is invisible \u2014 the reader doesn't notice it, they just understand. Rewriting is writing; the first draft is just raw material."
  },
  {
    id: "public-speaking",
    label: "Public Speaking",
    quote: "There are only two types of speakers: the nervous and the liars. \u2014 Mark Twain",
    summary: "The ability to communicate ideas clearly and compellingly to a room \u2014 whether five people or five thousand. Great public speaking is not about performance; it is about connection. The best speakers don't impress audiences \u2014 they make audiences feel something and understand something they didn't before. Structure beats style every time.",
    books: ["made-to-stick", "how-to-win-friends", "crucial-conversations", "very-good-copy", "writing-busy-readers", "emotional-intelligence", "youre-invited"],
    unifiedPrinciple: "Know your one point before you walk in the room. Everything else \u2014 delivery, slides, stories \u2014 is in service of that one point. Clarity of idea is the foundation; everything else is execution."
  },
  {
    id: "acquisition",
    label: "Acquisition",
  ...
  },
  {
    ...
    books: ["never-split-difference", "how-to-win-friends", "greatest-salesman", "made-to-stick", "million-dollar-weekend", "very-good-copy", "crossing-chasm", "youre-invited", "emotional-intelligence", "lean-startup", "build-fadell"],
    unifiedPrinciple: "Sales is not about closing \u2014 it is about understanding. The best sale feels like a natural conclusion to a conversation where the customer felt genuinely heard. Know the customer's problem better than they do, and the solution sells itself."
  },
  {
    id: "influence",
    label: "Influence",
    ...
    summary: "The ability to change what people think, feel, or do \u2014 without force or formal authority. Influence is the currency of leadership, sales, relationships, and ideas. The most durable influence comes from genuine interest in others, consistent credibility over time, and framing ideas in terms of what the other person already cares about.",
    books: ["how-to-win-friends", "never-split-difference", "made-to-stick", "youre-invited", "crucial-conversations", "emotional-intelligence", "greatest-salesman", "leadership-challenge", "very-good-copy", "writing-busy-readers", "no-rules-rules", "culture-code"],
    unifiedPrinciple: "Influence flows toward those who give value first, listen most, and frame everything in terms of the other person's interests. Credibility is the foundation \u2014 without it, every technique is just manipulation with a time limit."
  },
  {
    id: "negotiation",
    label: "Negotiation",
    quote: "No deal is better than a bad deal. \u2014 Chris Voss",
    summary: "The process of reaching agreements where interests differ \u2014 in acquisitions, salary discussions, partnerships, and everyday decisions. The biggest shift in modern negotiation theory: logic loses to emotion. Tactical empathy, calibrated questions, and making the other side feel heard are more powerful than any rational argument.",
    books: ["never-split-difference", "crucial-conversations", "how-to-win-friends", "buying-small-business", "buy-build", "million-dollar-weekend", "emotional-intelligence", "thinking-fast-slow"],
    unifiedPrinciple: "All negotiation is emotional first, rational second. Get to the other side's actual interests \u2014 not their stated positions \u2014 and you've already won half the negotiation before you've made a single ask."
  }
];
